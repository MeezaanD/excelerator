	...
	<div
		...
		<div class="p-4">
			<div class="flex justify-between items-center mb-4">
				...
				<div
					class="text-sm text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-700 px-2 py-1 rounded-md">
							...
							<tr>
								<th v-for="(value, key, index) in sheetData[0]" :key="key"
									...
									<div class="flex items-center justify-between">
										...
										<button
											class="text-slate-400 hover:text-slate-600 transition-colors ml-1 shrink-0">
